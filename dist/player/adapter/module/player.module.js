...
const player_repository_module_1 = require("../../framework/database/player.repository.module");
...
PlayerModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [{ provide: module_1.IPlayerService, useClass: player_service_1.PlayerService }],
        exports: [module_1.IPlayerService, player_repository_module_1.PlayerRepositoryModule],
    })
], PlayerModule);
