...
@Injectable()
export class ArbitreRepository
  implements IArbitreRepository, OnApplicationBootstrap
{
  ...
  onApplicationBootstrap(): void {
    this.arbitres = new DBGenericRepository<ArbitreEntity>(
      this.arbitreRepository,
    );
  }
}
