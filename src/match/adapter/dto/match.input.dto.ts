...
export class MatchAccoutDTO {
  ...
  @ApiProperty({
    description: 'Liste des IDs des arbitres',
    type: [String],
    example: [
  ...
  @ApiProperty({
    description: "ID de l'équipe à domicile",
    type: String,
  ...
  @ApiProperty({
    description: "ID de l'équipe à l'extérieur",
    type: String,
    example: 'd290f1ee-6c54-4b01-90e6-d701748f0851',
  })
  // @ValidateNested()
  ...
  @ApiProperty({
    description: 'Match dans les séances de tir aux buts',
    type: Boolean,
  })
  @IsOptional()
  // @ValidateNested()
  ...
  @ApiProperty({
    description: "Score de l'équipe a domicile au tir aux buts",
    type: Number,
    example: 1,
    required: false,
  })
  ...
  @ApiProperty({
    description: "Score de l'équipe à l'extérieur au tir aux buts",
    type: Number,
    example: 1,
    required: false,
  })
  ...
  @ApiProperty({
    description: "ID de l'équipe qualifiée",
    type: String,
    example: 'd290f1ee-6c54-4b01-90e6-d701748f0851',
  })
  @IsOptional()
