...
export enum CategoryName {
  ...
  MATCH_GOAL_SCORER = 'MATCH_GOAL_SCORER',
  MATCH_TEAM_QUALIFY = 'MATCH_TEAM_QUALIFY',
  FIRST_HALF_RESULT = 'FIRST_HALF_RESULT',
  SECOND_HALF_RESULT = 'SECOND_HALF_RESULT',
  COMPETITION_WINNER = 'COMPETITION_WINNER',
  COMPETITION_TOP_SCORER = 'COMPETITION_TOP_SCORER',
  COMPETITION_TOP_ASSIST = 'COMPETITION_TOP_ASSIST',
