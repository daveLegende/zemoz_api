...
import { TournoiCouponBetEntity } from "src/tournoiCouponBet/framework/schema/tournoi_coupon_bet.entity";
...
export class TournoiCouponEntity extends ATimestamp implements TournoiCoupon {
    ...
    @OneToMany(() => TournoiCouponBetEntity, (couponBet) => couponBet.tournoiCoupon)
    ...
    @Column({ type: 'enum', enum: TournoiCouponState, default: TournoiCouponState.PENDING })
