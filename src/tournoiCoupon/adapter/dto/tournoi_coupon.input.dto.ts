...
export class TournoiCouponAccountDto {
    ...
    @ApiProperty({ description: 'Les cotes avec les options', type: BetTournoiCoupon })
    @IsArray()
...
export class UpdateTournoiCouponDTO extends PartialType(TournoiCouponAccountDto) {
    @ApiProperty({
        type: String,
        name: 'id',
        description: 'ID',
